...
def test_second(driver_with_browser_2):
    ...
    input_6.click()
    select = Select(driver_with_browser_2.find_element
                    (By.XPATH, "//select[@class='react-datepicker__month-select']"))
    select.select_by_visible_text("April")
    select_year = Select(driver_with_browser_2.find_element
                         (By.XPATH, "//select[@class='react-datepicker__year-select']"))
    select_year.select_by_visible_text("1998")
    day_choice = driver_with_browser_2.find_element(
        By.XPATH, "//div[@class='react-datepicker__day react-datepicker__day--029' and text()='29']")
    day_choice.click()
    ...
    sleep(5)
    input_8 = driver_with_browser_2.find_element(
        By.XPATH, "//label[@class='custom-control-label' and text()='Music']")
    input_8.click()
    ...
    table_rows = (driver_with_browser_2.find_elements
                  (
